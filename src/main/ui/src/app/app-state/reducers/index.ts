...
import * as fromCreateAccount from './createaccount';
...
const reducerKeys = ['loggedinaccount'];
...
export const getCreateAccountState = createFeatureSelector<fromCreateAccount.State>('createAccount');

export const getAccounts = createSelector(
  getCreateAccountState,
  fromCreateAccount.getAccounts
);
